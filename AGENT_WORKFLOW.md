...
- No code, logic, or analysis was generated by ChatGPT — its role was limited to sentence-level editing of text we had already written
...
## Notes
This project represents a combination of manual implementation and selective AI assistance for specific components, particularly the mathematical template generation and code sanity checks. Written documentation (README and this file) reflects our own content and decisions, with ChatGPT used only to polish grammar and sentence clarity.
